<template>
  <div>
    <div class="block" style="width: 720px;float: left">
      <!--<div style="margin-bottom: 25px">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item v-if="SatelliteID==='GF5'"><span style="color: #d43c33">高分五号</span></el-breadcrumb-item>
          <el-breadcrumb-item v-else-if="SatelliteID==='ZY1E'"><span style="color: #d43c33">资源一号</span></el-breadcrumb-item>
          <el-breadcrumb-item v-else-if="SatelliteID==='HJ2A'"><span style="color: #d43c33">环境2A号</span></el-breadcrumb-item>
          <el-breadcrumb-item v-else-if="SatelliteID==='HJ2B'"><span style="color: #d43c33">环境2B号</span></el-breadcrumb-item>
        </el-breadcrumb>
      </div>-->
      <div style="margin-bottom: 25px">
        <el-breadcrumb separator-class="el-icon-arrow-right">
